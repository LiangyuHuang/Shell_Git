...
rm a
./shrug-add a >> output
./shrug-commit delete-a >> output
./shrug-log >> output
./shrug-show :a >> output
./shrug-show 4:c >> output
./shrug-show :c >> output

./shrug-rm --cached c >> output
./shrug-show :c >> output

./shrug-commit -m delete-a >> output
./shrug-log >> output
./shrug-show :a >> output
./shrug-show 4:c >> output
./shrug-show :c >> output
...
echo "1 :a" >> sample
echo "0 first commit" >> sample
echo "./shrug-show: error: 'a' not found in index" >> sample
echo "c" >> sample
echo "c" >> sample
echo "./shrug-show: error: 'c' not found in index" >> sample
...
echo "c" >> sample
echo "./shrug-show: error: 'c' not found in index" >> sample
echo "./shrug-rm: error: 'c' is not in the shrug repository" >> sample
echo "./shrug-show: error: 'c' not found in index" >> sample
